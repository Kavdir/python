...
pattern_for_name = '[A-ZА-Я][a-zа-я]+'
pattern_for_surname = pattern_for_name
pattern_for_email = '[a-z_0-9]+@[a-z0-9]+\.(ru|org|com)'

name = input('Введите имя с заглавной буквы: ')
surname = input('Введите фамилию с заглавной буквы: ')
email = input('Введите email в нижнем регистре: ')

result_name = re.match(pattern_for_name, name)
result_surname = re.match(pattern_for_surname, surname)
result_email = re.match(pattern_for_email, email)
...
if (re.search(pattern, some_str)) is not None:
    print('В тексте есть более одной точки, идущие подряд')
else:

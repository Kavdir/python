...
class Person:
    ...
    def _income_damage(self, damage):
        ...
        print('{} received a damage and now has {} health and {} armor'.format(self.name, self.health, self.armor))
...
class Fight:
    ...
    def start(self, person1, person2):
        while person1.health > 0 and person2.health > 0:
            ...
            if person2.health == 0:
                print('============ {} has won !'.format(person1.name))
                break
            person2.punch(person1)
            if person1.health == 0:
                print('============ {} has won !'.format(person2.name))


player = Player('The Chosed One', 100, 10, 50)
enemy = Enemy('Agent Smith', 100, 10, 50)
